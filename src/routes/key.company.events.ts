    ...
    app.get('/v1/key/company/events', async (request) => {
        ...
        const where: Prisma.AuditEventWhereInput = {
            ...
            ...(filters.actorEmail
                ...
                : {}),
            ...(filters.workspaceId
                ? { workspaceId: { equals: filters.workspaceId } }
                : {}),
            ...(filters.projectId
        ...
        const { events, total } = await queryCompanyEvents(ctx.company.id, {
            ...
            ...(createdAtFilter.gte && { from: createdAtFilter.gte as Date }),
            ...(createdAtFilter.lte && { to: createdAtFilter.lte as Date })
        });
