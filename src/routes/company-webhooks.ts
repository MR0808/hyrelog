// src/routes/company-webhooks.ts
import { FastifyInstance } from 'fastify';
import { UpdateWebhookSchema } from '../schemas/webhooks';
import { signWebhook } from '../utils/webhook-signature';

export default async function companyWebhookRoutes(fastify: FastifyInstance) {
    /**
     * ---------------------------------------------------------------------
