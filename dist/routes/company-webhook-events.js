...
exports.default = companyWebhookEventRoutes;
 ...
 */
async function companyWebhookEventRoutes(fastify) {
    /**
     * ---------------------------------------------------------
     * GET /v1/company/webhooks/events
     ...
     * ---------------------------------------------------------
     */
    fastify.get('/v1/company/webhooks/events', {
        config: {
            rateLimit: {
                max: 20,
                timeWindow: '1 minute'
        ...
        let limit = limitInput !== undefined ? Number(limitInput) : DEFAULT_LIMIT;
     ...
     * ---------------------------------------------------------
     */
    fastify.get('/v1/company/webhooks/events/:id', {
        config: {
            rateLimit: {
                max: 20,
                timeWindow: '1 minute'
