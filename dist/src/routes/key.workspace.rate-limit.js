/**
 * Rate limit status endpoints for workspace keys
...
export const keyWorkspaceRateLimitRoutes = async (app) => {
    /**
     * Get rate limit status for workspace key
     * GET /v1/key/workspace/rate-limit
     */
    app.get("/v1/key/workspace/rate-limit", async (request, reply) => {
...
//# sourceMappingURL=key.workspace.rate-limit.js.map