...
import { ApiKeyType, BillingCycle, BillingMeterType, DataRegion, Region, PrismaClient, WebhookDeliveryStatus, ThresholdType, GdprRequestType, GdprRequestStatus } from '@prisma/client';
...
async function main() {
    ...
    console.log('   2. Run archival job: npm run worker (or wait for cron at 4 AM)');
    console.log('   3. Test archive export: GET /v1/key/company/export-archive.json');
